...
const HeaderSearch = () => {
    return (
        <div className="flex md:flex-row flex-col justify-between items-center lg:gap-x-[68px] gap-x-10 gap-y-6">
            <div className="relative flex w-full shrink">
                ...
                <Input placeholder="Search Products" className="text-[#97B5CD] lg:pl-16 pl-10 pr-8" />
