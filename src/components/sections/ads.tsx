...
const Ads = () => {
    ...
    return (
        <section className="max-w-[1142px] mx-auto lg:mt-[200px] lg:mb-30 mb-20 mt-30">
            <div>
                <h2 className="uppercase text-secondary-foreground text-center lg:text-5xl text-4xl lg:leading-normal leading-normal font-bold">{t("order_now")}</h2>
                <h3 className="text-center text-[rgba(82,131,171,0.60)] lg:text-[40px] text-3xl lg:leading-[150%] font-bold mt-4">{t("order_now_details")}<span className=" text-secondary-foreground font-black"> {t("dont_wait")}</span></h3>
            </div>
            <div className="flex justify-center flex-wrap gap-x-[84px] lg:mt-[64px] mt-10">
                ...
                <div>
                    ...
                    <div className="text-center mt-[34px]">
                        <Button size={"lg"} className="lg:w-[300px]">{t('shop_now')}</Button>
