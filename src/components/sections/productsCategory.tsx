  ...
  return (
    <div className="px-[15px] lg:px-7.5 overflow-x-auto scrollbar-hidden">
      <div className="flex lg:gap-6 min-w-[1380px]">
        {categoryData.map(({  id, img, path, labelKey }) => (
          <div key={id} className="text-center flex flex-col items-center">
            ...
            <Link
              to={path}
              className="text-primary-foreground lg:text-[32px] text-[26px] font-bold text-center relative after:absolute after:left-0 after:bottom-0 after:w-full after:h-[3px] after:bg-primary hover:opacity-80 transition-all duration-500"
            >
              {t(labelKey)}
            </Link>
          </div>
